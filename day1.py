...
#
# input_dir = Path('puzzle_input/day1/input.txt')
#
# f = open(input_dir, 'r')
#
...
# max_iters = 100
# i = 0
# while len(nums) > 1 and i < max_iters:
#     smallest = min(nums)
#     nums = list(filter(lambda num: 2020 - smallest > num, nums))
#     i+=1
